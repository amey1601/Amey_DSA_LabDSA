...
In this question i hav hard coded the input as given in the question , but as a comment I have also given the code required to take the inputs like " total nodes in the BST" and then "value of nodes "  from the user and work on the BST created after taking inputs from the user.
